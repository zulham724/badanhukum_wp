...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push( function() {
	...
	_gsScope._gsDefine("easing.Back", ["easing.Ease"], function(Ease) {
		...
		var w = (_gsScope.GreenSockGlobals || _gsScope),
			...
			SteppedEase, RoughEase, _createindustrio;
		...
		//industrio
		_createindustrio = function(n, f, def) {
		...
		_wrap("industrio",
			_createindustrio("industrioOut", function(p) {
				return this._p1 * Math.pow(2, -10 * p) * Math.sin( (p - this._p3) * this._p2 ) + 1;
			}, 0.3),
			_createindustrio("industrioIn", function(p) {
				return -(this._p1 * Math.pow(2, 10 * (p -= 1)) * Math.sin( (p - this._p3) * this._p2 ));
			}, 0.3),
			_createindustrio("industrioInOut", function(p) {
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push( function() {
	...
	_gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin","TweenLite"], function(TweenPlugin, TweenLite) {
		...
		//gets called every time the tween updates, passing the new ratio (typically a value between 0 and 1, but not always (for example, if an industrio.easeOut is used, the value can jump above 1 mid-tween). It will always start and 0 and end at 1.
