...
<section class="contact-info-style-one">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="title">
                        <?php echo wp_specialchars_decode(esc_attr($industrio_redux_demo['footer_title']));?>
                        <?php echo wp_specialchars_decode(esc_attr($industrio_redux_demo['footer_subtitle']));?>
                    </div><!-- /.title -->
                </div><!-- /.col-md-7 -->
                <div class="col-md-6">
                    <div class="contact-infos">
                        <div class="single-contact-infos">
                            ...
                            <div class="text-box">
                                <?php echo wp_specialchars_decode(esc_attr($industrio_redux_demo['footer_phone']));?>
                            </div><!-- /.text-box -->
                        ...
                        <div class="single-contact-infos">
                            ...
                            <div class="text-box">
                                <?php echo wp_specialchars_decode(esc_attr($industrio_redux_demo['footer_email']));?>
                            </div><!-- /.text-box -->
                        </div><!-- /.single-contact-infos -->
                    </div><!-- /.contact-infos -->
                </div><!-- /.col-md-5 -->
