...
class Avada_Widget_Style {
	 ...
	 */
	public function filter_widget_title( $title = '', $instance = false, $base_id = false ) {
		if ( $instance && is_array( $instance ) && isset( $instance['fusion_display_title'] ) && 'no' === $instance['fusion_display_title'] ) {
			return '';
		}
